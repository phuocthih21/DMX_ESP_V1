 ...
 * 
 * Encodes RGB data into RMT symbols with WS2812B timing
 */
...
/**
 * @brief WS2812B timing configuration (10MHz RMT clock)
 * 
 * WS2812B Protocol:
 ...
 * - Reset: >50us LOW
 * 
 * With 10MHz clock (0.1us per tick):
...
esp_err_t rmt_new_led_strip_encoder(const led_strip_encoder_config_t *config, rmt_encoder_handle_t *ret_encoder)
{
    ...
    rmt_bytes_encoder_config_t bytes_encoder_config = {
        ...
        .flags.msb_first = 1  // WS2812B requires MSB first
    };
